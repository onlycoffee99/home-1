...
line(520,250,330,250)
box(90,178,240,34,(112,48,160),'文化顧問／講師',fs=18); box(90,212,240,80,GRAY,'黃教授（鐵道文化史）\n蔡錦佳老師',tc='black',fs=18)
line(520,250,700,250)
box(700,150,300,34,(230,170,0),'協力廠商',fs=18); box(700,184,300,150,GRAY,'廣廓生活有限公司\n傳宇智聯有限公司\n東華印刷局資訊科技企業社\n台灣瑰寶牛樟芝生物科技有限公司',tc='black',fs=17)
