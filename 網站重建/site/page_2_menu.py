...
""" + T("手選咖啡(S/M/L)",["品項","S","M","L"],[
["水果鉑金(NO.3號)|Light Roast<br><span class='muted'>熱口感酸甜水果,溫口感花香,清爽果味最令人著迷</span>","110","140","170"],
["鉑金級(NO.4號)|Cinnamon Roast<br><span class='muted'>熱口感甘性出現,溫口感莓果酸甜,柔美雅致</span>","100","120","150"],
["精品級(NO.5號)|Medium Roast<br><span class='muted'>前味微苦甘香,尾韻葡萄乾與熱帶水果甘味最集中</span>","120","150","180"],
...
["冰黑咖啡 Ice black coffee","130","150"],
["青檸冰咖啡 Lime ice coffee<br><span class='muted'>檸檬與咖啡的美味激盪</span>","150",""],
["冰滴咖啡 Ice drip coffee<br><span class='muted'>12小時直取(0.1咖啡因)</span>","","180"],
]) + T("花式咖啡(冰/熱)|換置燕麥奶+30元",["品項","M","L"],[
["鮮奶咖啡 Latte","130","150"],["卡布其諾 Cappuccino","130","150"],
["榛果歐蕾 Hazelnut Latte","140","160"],["焦糖歐蕾 Caramel Latte","140","160"],
["黑糖歐蕾 Brown Sugar Latte","140","160"],["太妃歐蕾 Toffee Latte","140","160"],
["摩卡可可 Café Mocha","150","170"],["港式鴛鴦奶茶 Coffee with Milk Tea","130","150"],
...
["新鮮手作蘋果茶 Apple Tea","","150"],
["宜蘭省產金棗茶(熱) Kumquat Tea","120","140"],
["蜂蜜檸檬茶 Honey Lemon Tea","120","140"],
["綜合水果茶 Fruit Tea","","160"],
], "舞荳頂級植物草本茶系列(單一大杯 $150):樟香熟普洱/樟香生普洱/南非國寶茶+有機杭菊") + """
</section>
<section>
<h2>黃金可可飲&果汁氣泡</h2>
""" + T("黃金可可飲(冰/熱)",["品項","M","L"],[
...
["焦糖香純可可 Caramel Cocoa","150","170"],["太妃香純可可 Toffee Cocoa","150","170"],
["莓果歐蕾可可冰沙 Berry Cocoa Smoothie","","180"],["香蕉歐蕾可可冰沙 Banana Cocoa Smoothie","","180"],
]) + T("時令果汁&特別氣泡 Juice & Soda",["品項","價格"],[
...
["蜂蜜蘇打 Honey Soda","150"],["檸檬蘇打 Lemon Soda","150"],["綜合水果蘇打 Mixed Fruit Soda","180"],
]) + T("時令點心(以現場為主)",["品項","價格"],[
